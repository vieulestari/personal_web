  ...
  <main class="w-3/4 bg-white dark:bg-gray-800 rounded shadow p-6">
    <div class="flex justify-between items-center mb-6">
      ...
      <a href="add_about.php"
         class="bg-gradient-to-r from-pink-400 to-purple-500 text-white px-5 py-2 rounded shadow hover:brightness-110 transition">
        + Tambah Data
      </a>
    </div>
    ...
    <div class="space-y-4">
      ...
      while ($data = mysqli_fetch_array($query)) {
        echo "<div class='p-4 bg-purple-50 dark:bg-gray-700 border border-purple-200 dark:border-gray-600 rounded shadow'>";
        echo "<p class='mb-3 text-gray-700 dark:text-white leading-relaxed'>" . nl2br(htmlspecialchars($data['about'])) . "</p>";
...
<footer class="bg-gradient-to-r from-purple-300 via-yellow-100 via-pink-200 to-blue-200 
               dark:from-indigo-900 dark:via-purple-800 dark:to-indigo-900 
               text-center py-4 shadow dark:text-white mt-10 font-bold transition-all duration-300">
