...
<div class="flex max-w-7xl mx-auto mt-8 px-4 gap-6">
  ...
  <aside class="w-1/4 bg-white dark:bg-gray-800 rounded shadow p-4 text-sm dark:text-gray-200">
    <h2 class="text-xl font-bold text-center text-purple-700 dark:text-pink-300 mb-4">MENU</h2>
    <ul class="space-y-2">
    ...
    <form action="proses_add_artikel.php" method="post" class="space-y-6">
      <div>
        ...
        <input type="text" id="nama_artikel" name="nama_artikel" required
               class="w-full p-3 border rounded bg-gray-50 dark:bg-gray-700 dark:text-white dark:border-gray-600 focus:outline-none focus:ring focus:border-purple-500">
      </div>
      <div>
        ...
        <textarea id="isi_artikel" name="isi_artikel" rows="6" required
                  class="w-full p-3 border rounded bg-gray-50 dark:bg-gray-700 dark:text-white dark:border-gray-600 focus:outline-none focus:ring focus:border-purple-500"></textarea>
      </div>
      <div class="flex justify-end space-x-4">
        <button type="submit" class="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-5 py-2 rounded shadow hover:brightness-110 transition">
          Simpan
        </button>
        <a href="data_artikel.php" class="bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-white px-5 py-2 rounded hover:bg-gray-400 dark:hover:bg-gray-500 transition">
          Batal
        </a>
      </div>
    </form>
