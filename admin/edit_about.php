...
<div class="flex max-w-7xl mx-auto mt-8 px-4 gap-6">
  ...
  <main class="w-3/4 bg-white dark:bg-gray-800 rounded shadow p-6">
    <form action="proses_edit_about.php" method="post">
      ...
      <div>
        <label for="about" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Edit Konten About</label>
        <textarea id="about" name="about" rows="5" required
                  class="w-full p-3 border rounded bg-gray-50 dark:bg-gray-700 dark:text-white 
                         dark:border-gray-600 focus:outline-none focus:ring focus:border-blue-500"><?php echo htmlspecialchars($data['about']); ?></textarea>
      </div>
