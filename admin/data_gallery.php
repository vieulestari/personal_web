...
<div class="flex max-w-7xl mx-auto mt-8 px-4 gap-6">
  ...
  <main class="w-3/4 bg-white dark:bg-gray-800 rounded shadow p-6">
    <div class="flex justify-between items-center mb-6">
      <h2 class="text-xl font-bold text-gray-800 dark:text-white">Daftar Gambar Gallery</h2>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
      ...
      while ($data = mysqli_fetch_array($query)) {
        ...
        echo "<img src='../images/{$data['foto']}' alt='{$data['judul']}' class='w-full h-48 object-cover'>";
        echo "<div class='p-4'>";
        ...
        echo "<a href='edit_gallery.php?id_gallery={$data['id_gallery']}' class='text-blue-600 dark:text-blue-300 hover:underline'>Edit</a>";
