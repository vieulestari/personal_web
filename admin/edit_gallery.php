      ...
      <div>
        ...
        <input type="text" id="judul" name="judul" required
               ...
               class="w-full p-3 border rounded bg-gray-50 dark:bg-gray-700 dark:text-white 
                      dark:border-gray-600 focus:outline-none focus:ring focus:border-blue-500">
      </div>

      <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Gambar Saat Ini</label>
        <img src="../images/<?php echo $data['foto']; ?>" alt="Foto Lama"
             class="h-40 rounded shadow border border-gray-300 mb-3">
      </div>
      ...
      <div>
        ...
        <input type="file" id="foto" name="foto" accept="image/*"
               class="block w-full text-sm text-gray-600 file:mr-4 file:py-2 file:px-4
                      ...
                      file:bg-blue-100 file:text-blue-700 hover:file:bg-blue-200 dark:file:bg-purple-200 dark:file:text-purple-900">
      </div>
