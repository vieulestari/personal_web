...
<div class="flex max-w-7xl mx-auto mt-8 px-4 gap-6">
  ...
  <aside class="w-1/4 bg-white dark:bg-gray-800 rounded shadow p-4 text-sm dark:text-gray-200">
    ...
    <ul class="space-y-2">
      ...
      <li><a href="about.php" class="block font-semibold text-purple-800 dark:text-white">About</a></li>
  ...
  <main class="w-3/4 bg-white dark:bg-gray-800 rounded shadow p-6">
    <form action="proses_add_about.php" method="post" class="space-y-6">
      ...
      <div class="flex justify-end space-x-4">
        <button type="submit"
                class="bg-gradient-to-r from-pink-400 to-purple-600 text-white px-5 py-2 rounded shadow hover:brightness-110 transition">
          Simpan
        </button>
        <a href="about.php"
