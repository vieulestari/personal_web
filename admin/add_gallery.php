...
<div class="flex max-w-7xl mx-auto mt-8 px-4 gap-6">
  ...
  <aside class="w-1/4 bg-white dark:bg-gray-800 rounded shadow p-4 text-sm dark:text-gray-200">
    ...
    <ul class="space-y-2">
      ...
      <li><a href="data_gallery.php" class="block font-semibold text-purple-800 dark:text-white">Kelola Gallery</a></li>
    ...
    <form action="proses_add_gallery.php" method="post" enctype="multipart/form-data" class="space-y-6">
      <div>
        ...
        <input type="text" id="judul" name="judul" required
               class="w-full p-3 border rounded bg-gray-50 dark:bg-gray-700 dark:text-white 
                      dark:border-gray-600 focus:outline-none focus:ring focus:border-purple-500">
      </div>
      ...
      <div>
        ...
        <input type="file" id="foto" name="foto" accept="image/*" required
               class="block w-full text-sm text-gray-600
                      ...
                      file:font-semibold
                      file:bg-pink-100 file:text-purple-700 hover:file:bg-pink-200
                      dark:file:bg-purple-200 dark:file:text-purple-900">
      </div>

      <div class="flex justify-end space-x-4">
        <button type="submit"
                class="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-5 py-2 rounded shadow hover:brightness-110 transition">
          Simpan
        </button>
        <a href="data_gallery.php"
           class="bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-white px-5 py-2 rounded hover:bg-gray-400 dark:hover:bg-gray-500 transition">
          Batal
        </a>
      </div>
    </form>
